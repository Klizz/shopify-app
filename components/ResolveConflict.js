...
const ResolveConflict = ({
    ...
    return(
        ...
        >
            <Modal.Section>
                <TextContainer>
                    <div>Nuestros expertos sugieren diferentes impuestos que los que usted ha indicado
                        Seleccione cual es el correcto
                    </div>
                    ...
                    <Stack distribution="fillEvenly">
                        <Card sectioned>
                            ...
                            <div className="text-center mt-10">
                                ...
                                primary={hasPaginator.price_selected==='original' && MobileAcceptMajorMonotone}
                                >
                                    Seleccionar
                                </Button>
                            </div>
